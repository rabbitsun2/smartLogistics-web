...
-- 테이블 hr.smart_factory_warehouse 구조 내보내기
CREATE TABLE IF NOT EXISTS `smart_factory_warehouse` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_no` int(11) DEFAULT NULL,
  `product_cnt` int(11) DEFAULT NULL,
  `create_date` datetime DEFAULT NULL,
  `create_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
